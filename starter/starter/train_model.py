...
if __name__ == '__main__':
    ...
    pickle.dump(model, open(os.path.join(STARTER_ROOT,config.model.GradientBoostingClassifier.output_file_pth) , "wb"))
    pickle.dump(encoder, open(os.path.join(STARTER_ROOT, config.preprocessing.encoder_file_path), "wb"))
    pickle.dump(lb, open(os.path.join(STARTER_ROOT,config.preprocessing.binarizer_file_path), "wb"))
